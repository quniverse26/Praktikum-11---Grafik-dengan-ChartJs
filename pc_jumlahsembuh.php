...
while ($row = mysqli_fetch_array($kasus)) {
	...
	$query = mysqli_query($koneksi, "SELECT sum(jumlah_sembuh) as jumlah_sembuh FROM tb_covid where id_kasus='". $row['id_kasus']."'");
...
<head>
	<title> Pie Chart - Jumlah Sembuh </title>
		...
		var config = {
			...
			data: {
				datasets: [{
					...
					label: 'Presentase Jumlah Sembuh Covid-19'
				}],
